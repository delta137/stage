...
ar=sys.argv
p[0],p[1],p[3]=float(ar[1]),float(ar[2]),float(ar[4])
p[2],p[4]=float(ar[3]),float(ar[5])

#if(p[4] <= p[3]*(p[2])*(p[2]+1)/p[0]):quit() 
...
f = open('%s_%s_%s_%s_%s.txt' %(ar[1],ar[2],ar[3],ar[4],ar[5]), 'a')
