...
q=2 #nombre de degres de libertes
...
def rk4(V):
    """V sont les conditions initiales devinées, pour les N-n2 composantes
...
#difference entre l'integration et la cible        
